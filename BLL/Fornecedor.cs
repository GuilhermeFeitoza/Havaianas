...
namespace BLL
{
    public class Fornecedor
    {
        ...
        public void Incluir()
        {
            try
            {
                instrucaoSql = "INSERT INTO tbFornecedor (NomeFantasia, RazaoSocial,CNPJ,CEP,Complemento,Numero,Tel,Email,StatusFornecedor) Values ('" + _NomeFantasia + "','" + _RazaoSocial + "','" + _CNPJ + "','" + _CEP + "','" + _Complemento + "','" + _Numero + "','" + _Email + "','" + _CEP + "', +_StatusFornecedor +  )";
        ...
        public void IncluirComParametro()
        {
            try
            {
                ...
                instrucaoSql = "INSERT INTO tbFornecedor (NomeFantasia, RazaoSocial, CNPJ,CEP,Complemento,Numero,Tel,Email,StatusFornecedor) VALUES (@NomeFantasia, @RazaoSocial, @CNPJ,@CEP,@Complemento,@Numero,@Tel,@Email,@StatusFornecedor)";
        ...
        public void AlterarComParametro()
        {
            try
            {
                ...
                instrucaoSql = "UPDATE tbFornecedor SET NomeFantasia=@NomeFantasia, RazaoSocial=@RazaoSocial,CNPJ=@CNPJ,CEP=@CEP,Complemento=@Complemento,Numero=@Numero,Tel=@Tel,Email=@Email,StatusFornecedor=@StatusFornecedor WHERE CodigoFornecedor=@CodigoFornecedor";
                c.ExecutarComandoParametro(instrucaoSql, listaComParametros);
        ...
        public int IncluirRetornarNumeroAutomatico()
        {
            try
            {
                instrucaoSql = "INSERT INTO tbFornecedor (NomeFantasia, RazaoSocial,CNPJ,CEP,Complemento,Numero,Tel,Email,StatusFornecedor) Values ('" + _NomeFantasia + "','" + _RazaoSocial + "','" + _CNPJ + "','" + _CEP + "','" + _Complemento + "','" + _Numero + "','" + _Tel + "','" + _Email + "','" + _CEP + "', +_StatusFornecedor +  )";
        ...
        public void Excluir()
        {
            try
            {
                instrucaoSql = "DELETE FROM tbFornecedor  WHERE CodigoFornecedor=" + _CodigoFornecedor;
                c.ExecutarComando(instrucaoSql);
            }
            catch (Exception ex)
            {
        ...
        public DataSet ListarAtivos()
        {
            try
            {
                instrucaoSql = "SELECT CodigoFornecedor, NomeFantasia, StatusFornecedor FROM tbFornecedor WHERE StatusFornecedor=1";
                return c.RetornarDataSet(instrucaoSql);
            }
            catch (Exception ex)
            {
