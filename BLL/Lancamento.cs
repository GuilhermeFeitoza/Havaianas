    ...
    public class Lancamento
    {
        ...
        public void Pagar()
        {
            try
            {
                ...
                instrucaoSql = "UPDATE tbLancamento SET CodigoTitulo=@codtit, DataVencimento=@datavenc, ValorTitulo=@valortitulo, StatusPagTitulo=@status, DataPagamento=@datapag, ValorPagamento=@valorpag WHERE CodigoLancamento=@codlanc";
                c.ExecutarComandoParametro(instrucaoSql, listaComParametros);
